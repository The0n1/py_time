...
print('''
mmmmmmm mmmmm  mmmmm           mmm    mm   m        mmm  m    m m        mm  mmmmmmm  mmmm  mmmmm 
   #      #    #   "#        m"   "   ##   #      m"   " #    # #        ##     #    m"  "m #   "#
   #      #    #mmm#"        #       #  #  #      #      #    # #       #  #    #    #    # #mmmm"
   #      #    #             #       #mm#  #      #      #    # #       #mm#    #    #    # #   "m
   #    mm#mm  #              "mmm" #    # #mmmmm  "mmm" "mmmm" #mmmmm #    #   #     #mm#  #    "
''')
...
#final_payment = round((total_bill + total_tip #+ total_sales_tax) / total_guest, 2)
final_payment = round((total_bill + total_tip) / total_guest, 2)
